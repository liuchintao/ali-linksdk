...
/**
 * @brief -0x1C00~-0x1CFF表达SDK在ra模块内的状态码
 */
 ...
 */
#define  STATE_REMOTE_ACCESS_MISSING_PRODUCT_KEY                               (-0x1C05)
/**
 * @brief 用户输入参数中缺少deviceName
 */
#define  STATE_REMOTE_ACCESS_MISSING_DEVICE_NAME                               (-0x1C06)
/**
 * @brief 用户输入参数中缺少deviceSecret
 */
#define  STATE_REMOTE_ACCESS_MISSING_DEVICE_SECRET                             (-0x1C07)
/**
 * @brief 用户输入参数中缺少域名地址或IP地址
 */
#define  STATE_REMOTE_ACCESS_CLOUD_HOST                                        (-0x1C08)
/**
 * @brief 用户输入参数中缺少端口号
 */
#define  STATE_REMOTE_ACCESS_CLOUD_PORT                                        (-0x1C09)
/**
...
typedef enum {
    ...
    /**
     * @brief RA服务器的域名地址或者ip地址
     * 
     * 数据类型: (char *)
     */
    AIOT_RAOPT_CLOUD_HOST,
