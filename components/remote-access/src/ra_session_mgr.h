/*
 * remote_access_session_mgr.h
 *
 *  Created on: 2019年6月28日
 *      Author: weixia.lw
 */

#ifndef ADVANCED_SERVICES_REMOTE_ACCESS_DAEMON_REMOTE_ACCESS_SESSION_MGR_H_
#define ADVANCED_SERVICES_REMOTE_ACCESS_DAEMON_REMOTE_ACCESS_SESSION_MGR_H_
